      ...
      <form class="d-flex" role="search">
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name='name_ar' placeholder="{{__(key:'messages.Name')}}" >
            ...
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label">{{__(key:'messages.Offer en_Name')}}</label>
                <input type="text" class="form-control" name='name_en' placeholder="{{__(key:'messages.Name')}}" >
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name='price'  placeholder="{{__(key:'messages.Price')}}">
                @error('price')
                <small class="from-text text-danger">{{$message}}</small>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name='detals_ar'  placeholder="{{__(key:'messages.Details')}}">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name='detals_en'  placeholder="{{__(key:'messages.Details')}}">
